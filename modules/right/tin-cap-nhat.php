<div class="box no-padding no-border" style="padding-top: 10px">
  ...
  <div class="box-right" style="width:100%">
    <?php
	$sql="select idBaiViet, TieuDe, TenAnh from baiviet where 1 order by idBaiViet desc limit 11";//desc sắp xép giảm dần
	$baiviet = $con->query($sql);
	
	?>
    <?php foreach($baiviet as $row)
		{  ?>
    <div class="box-tin"> <a href="Index.php?xem=baiviet&id=<?php echo $row["idBaiViet"] ?>" > <img src="upload/<?php echo $row["TenAnh"] ?>" height="150px" />
