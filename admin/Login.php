...
<body>
<img width="100%" height="100%" src="img/login.jpg">
<div class="login">
  <form action="Login.php" method="POST">
    <table width="500px" border="0">
      <tr>
        <td rowspan="3" style="color:white; font-size:45px;">Site<span style="color:red">Login</span>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td><input type="text" placeholder="username" name="tentaikhoan">
          <br>
          <br></td>
      </tr>
      <tr>
        <td><input type="password" placeholder="password" name="matkhau">
          <br>
          <br></td>
      </tr>
      <tr>
